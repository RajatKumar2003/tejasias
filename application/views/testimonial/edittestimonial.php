    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                <h2><a href="<?php echo site_url('Testimonial') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Testimonial</a></h2>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form id="updatetestimonial" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                ...
                                <fieldset>
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <input type="hidden" name="Id" value="<?php echo ($editTestimonial) ? $editTestimonial->TestId : ''; ?>">
                                                <input type="text" name="name" value="<?php echo ($editTestimonial) ? $editTestimonial->Name : ''; ?>" class="form-control">
                                            </div>

                                            <div class="col-lg-5">
                                            <label for="">image </label>
                                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                    <div class="form-control" data-trigger="fileinput"> <span class="fileinput-filename" style="font-size: 11px;"><?php echo ($editTestimonial) ? $editTestimonial->Image : ''; ?></span></div>
                                                    <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new"><i class="fa fa-file-photo-o "></i></span><span class="fileinput-exists"><i class="fa fa-edit"></i></span><input type="file" name="image" onchange="imagechange(event)" value="<?php echo ($editTestimonial) ? $editTestimonial->Image : ''; ?>"></span>
                                                    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput"><i class="fa fa-trash"></i></a>
                                                    <span class="input-group-addon btn btn-default" onclick="previewImage('')" data-bs-toggle="modal" id="uploadBtn" <?php echo ($editTestimonial && empty($editTestimonial->Image)) ? 'disabled' : ''; ?> data-bs-target="#staticBackdrop"><i class="fa fa-eye"></i></span>
                                                </div>
                                            </div>
                                            ...
                                            <label for="">Status</label>
                                                <div class="switch">
                                                    <div class="onoffswitch">
                                                        ...
                                                        <input type="hidden" id="status" value="<?php echo ($editTestimonial) ? $editTestimonial->Status : ''; ?>" name="status">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col-lg-12">
                                                    ...
                                                    <textarea name="content" class="summernote" id=""><?php echo ($editTestimonial) ? $editTestimonial->Content : ''; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            if (!empty($testimoniallist)) {
                                                ...
                                                foreach ($testimoniallist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="issue-info"><?php echo $list->Content; ?></td>
                                                        <td><?php echo $list->Status == '1' ? "Active" : "Inactive"; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url('Testimonial/') . 'edittestimonial/' . $list->TestId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>

                                                            <button class="btn btn-danger btn-circle" type="button" onclick="showConfirmation('<?php echo $list->TestId ?>')"><i class="fa fa-trash"></i>
                                                            </button>
                                                            <a href="<?php echo base_url('uploads/testimonial/').$list->Image; ?>" target="_blank" class="btn btn-warning btn-circle"><i class="fa fa-file-photo-o "></i></a>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?php echo ($editTestimonial) ? base_url('uploads/testimonial/'). $editTestimonial->Image : ''; ?>" id="previewimage" alt="" style="width: 200px;">
      </div>
...
function performAjaxFunction(global_var) {
    ...
    <?php $this->load->view('testimonial/testimonialjs'); ?>
    <script>
        $(document).ready(function(){
