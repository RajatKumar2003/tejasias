                                            ...
                                            if (!empty($categorylist)) {
                                                ...
                                                foreach ($categorylist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Blog/') . 'editcategory/' . $list->CatId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>
...
function performAjaxFunction(global_var) {
            ...
            $.ajax({
                url: '<?php echo base_url() . 'Blog/deletecategory'; ?>',
                method: 'POST',
                data: {
                    id: global_var
                },
    ...
    <?php $this->load->view('blog/categoryjs'); ?>
