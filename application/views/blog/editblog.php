                                ...
                                <form id="<?php echo ($editBlog) ? "updateblog" : "addblog" ?>" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                                    ...
                                                    <select data-placeholder="Choose a Country..." class="chosen-select" name="category" tabindex="2">
                                                        ...
                                                        if (!empty($blogcategory)) {
                                                            foreach ($blogcategory as $category) {
                                                                if ($category->CatId == $editBlog->Category) {
                                                                    $option = "selected";
                                                                } else {
                                                                    $option = "";
                                                                }
                                                        ...
                                                        ?>
                                                                ...
                                                                <option value="<?php echo $category->CatId ?>" <?php echo $option; ?>><?php echo $category->Title ?></option>
                                            ...
                                            <div class="col-lg-5">
                                                <label>Title *</label>
                                                <input type="hidden" name="id" value="<?php echo $editBlog->BlogId; ?>">
                                                <input id="userName" name="title" type="text" class="form-control " value="<?php echo $editBlog->Title ?>">
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <div class="switch">
                                                    <div class="onoffswitch">
                                                        ...
                                                        <input type="hidden" id="status" value="<?php echo $editBlog->Status ?>" name="status">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                ...
                                                <input type="text" name="author" value="<?php echo $editBlog->AuthorName ?>" class="form-control">
                                            </div>
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                    <div class="form-control" data-trigger="fileinput">
                                                        <span class="fileinput-filename" style="font-size: 11px;"><?php echo $editBlog->Image ?></span>
                                                    </div>
                                                    <span class="input-group-addon btn btn-default btn-file">
                                                        ...
                                                        <input type="file" name="image" onchange="imagechange(event)">
                                                    </span>
                                                    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput"><i class="fa fa-trash"></i></a>
                                                    <!-- Add preview button -->
                                                    <span class="input-group-addon btn btn-default" onclick="previewImage('<?php echo base_url('uploads/blog/'). $editBlog->Image ?>')" data-bs-toggle="modal" disabled id="uploadBtn" data-bs-target="#staticBackdrop"><i class="fa fa-eye"></i></span>
                                                </div>
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <input type="date" name="date" class="form-control" value="<?php echo $editBlog->Date; ?>">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="shortdescription" class="form-control" id=""><?php echo $editBlog->ShortDescription ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="fulldescription" class="summernote" id=""><?php echo $editBlog->FullDescription ?></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover issue-tracker dataTables-example">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Title</th>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?php echo base_url('uploads/blog/').$editBlog->Image; ?>" id="previewimage" alt="" style="width: 200px;">
      </div>
