...
<script src="<?php echo base_url('assets/admin/') ?>js/plugins/ladda/spin.min.js"></script>
    <script src="<?php echo base_url('assets/admin/') ?>js/plugins/ladda/ladda.min.js"></script>
    <script src="<?php echo base_url('assets/admin/') ?>js/plugins/ladda/ladda.jquery.min.js"></script>
    ...
    <script src="<?php echo base_url('assets/admin/') ?>js/plugins/steps/jquery.steps.min.js"></script>
