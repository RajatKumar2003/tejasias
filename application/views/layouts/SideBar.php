        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img alt="image"  src="<?php echo base_url('uploads/seo/').$editseo->Logo; ?>" / width="170px">
                    </span>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <!-- <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $this->session->userdata('userName') ?></strong> -->
                        </span> <span class="text-muted text-xs block"><strong><?php echo $this->session->userdata('userName') ?></strong> </span> </span> </a>
                ...
                <div class="logo-element">
                    <img alt="image" class="img-circle" src="<?php echo base_url('uploads/seo/').$editseo->Favicon; ?>" />
                </div>
            </li>
            <!-- <li class="active">
                    <a href="<?php echo site_url('admin') ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> </span></a>
                 
                </li> -->

            <li class="active">
                <a href="<?php echo site_url('Inquiry') ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Enquiries</span> </span></a>
            ...
            <li>
                <a href="<?php echo site_url('Gallery') ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Galleries</span> </span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">General Setting</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li>
                        <a href="<?php echo site_url('Seo') ?>"> <span class="nav-label">Seo Tools</span> </span></a>
                    </li>
                 
                    <!-- <li>
                <a href="#"> <span class="nav-label">Navigation</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="<?php echo site_url('Navigation/parentlink') ?>">Parent Link</a></li>
                    <li><a href="<?php echo site_url('Navigation') ?>">Menu link</a></li>
